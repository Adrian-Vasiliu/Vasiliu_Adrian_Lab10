using Grpc.Core;
using Vasiliu_Adrian_Lab10;

namespace Vasiliu_Adrian_Lab10.Services
{
    public class GreeterService : Greeter.GreeterBase
    {
        ...
        public override Task<SResponse> SendStatus(SResponse request, ServerCallContext context)
        {
